		...
		<div class="row container">
			...
			<form action="banco_de_dados/create.php" method="post" class="col s12">
				<fieldset class="formulario" style="padding:15px;margin-bottom: 50px;">
					...
					<h5 class="light center">Cadastro de Parceiros</h5>
					...
					<!-- CAMPO CEP -->
					 ...
					 <div class="input-field col s6">
					 	...
					 	<input type="text" name="clinica" id="clinica" maxlength="40" required>
					 	<label for="Clinica">Clínica</label>
					 </div>
					<!-- BOTOES -->
					<div class="input-field col s12">
						<input type="submit" value="cadastrar" class="btn-large  waves-light teal lighten-1">
						<input type="reset" value="limpar" class="btn-large  waves-light red lighten-1">
					</div>
				</fieldset>
			</form>
		</div>
